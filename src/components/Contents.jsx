  ...
  return (
    <div className='flex mt-[200px] font-sans  flex-col p-[65px 50px] gap-14 justify-center items-center'>
      ...
      <div className=" flex gap-10 items-center justify-center flex-wrap">
        {content.map((content) => (
          <div className="contentCard flex h-[624px] rounded-[10px] py-[35px] text-black bg-white flex-col items-center pr-[20px] pl-[20px] w-[476px] gap-[57px]" key={content.name}>
